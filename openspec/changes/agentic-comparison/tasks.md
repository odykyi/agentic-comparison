...
- [x] 4.4 Gather command references for all 3 tools from official docs
- [x] 4.5 Map feature availability for each tool
- [x] 4.6 Collect official logos and brand assets (add to `assets/images/tools/`)
...
- [x] 5.1 Create `index.html` homepage with hero section and feature matrix preview
- [x] 5.2 Create `features/index.html` with full feature comparison table
- [x] 5.3 Implement DataTables.js integration for sorting and filtering
- [x] 5.4 Add category filter sidebar with expand/collapse functionality
- [x] 5.5 Implement tool column visibility toggle with localStorage persistence
...
- [x] 6.1 Create `commands/index.html` with command equivalency table
- [x] 6.2 Implement search functionality across command names and descriptions
- [x] 6.3 Add task category filter (file operations, git, search, etc.)
...
- [x] 6.6 Add "copy to clipboard" buttons for command examples
- [ ] 6.7 Create command comparison sidebars showing alternatives
- [x] 6.8 Add verification status badges (verified/community-contributed)

## 7. Terminology Mapper

- [x] 7.1 Create `terminology/index.html` with canonical concepts table
- [x] 7.2 Define canonical concept definitions in `_data/canonical_concepts.yml`
- [x] 7.3 Create cross-reference mapping for each tool's terminology
- [x] 7.4 Implement perspective toggle ("From Codex view" vs "From Claude view")
...
- [x] 8.1 Create `mcp/index.html` with MCP server catalog
- [x] 8.2 Create `_data/mcp_servers.yml` with initial server entries
- [x] 8.3 Implement compatibility filter by tool
- [x] 8.4 Add official vs community-maintained badges
- [ ] 8.5 Create integration guides for each tool+server combination
- [x] 8.6 Add MCP capability matrix (resources, prompts, tools, sampling)
...
- [x] 9.1 Create dynamic tool profile page generator using Jekyll collections
- [x] 9.2 Create `tools/opencode.html` profile page
- [x] 9.3 Create `tools/codex.html` profile page
- [x] 9.4 Create `tools/claude_code.html` profile page
- [ ] 9.5 Add architecture diagrams for each tool
- [x] 9.6 Create installation methods section with copy-paste commands
- [x] 9.7 Add feature deep-dive sections for each capability
- [ ] 9.8 Include version history and changelog integration

## 10. UI Showcase

- [x] 10.1 Create `ui/index.html` terminal interface gallery
...
- [x] 10.5 Create configuration file structure visualizations
- [ ] 10.6 Add IDE integration screenshots section
- [x] 10.7 Create accessibility features comparison table
- [ ] 10.8 Add UI customization options documentation

## 11. Pricing Calculator

- [x] 11.1 Create `pricing/index.html` with pricing comparison table
...
- [x] 11.5 Add free tier comparison matrix
- [x] 11.6 Document billing models with example calculations
...
- [x] 12.2 Add dark mode toggle with CSS variables
- [x] 12.3 Create sitemap.xml and robots.txt for SEO
- [x] 12.4 Add Open Graph meta tags for social sharing
- [x] 12.5 Implement "Edit this page" links to GitHub edit mode (ready to add)
- [x] 12.6 Add table of contents navigation for long pages (tool layout)
- [x] 12.7 Create progressive web app manifest
- [ ] 12.8 Add analytics (Plausible or Fathom) with privacy focus

## 13. Content Expansion (Phase 2: Additional Tools)

- [x] 13.1 Create `_data/tools/continue.yml` for Continue.dev
- [x] 13.2 Create `_data/tools/aider.yml` for Aider
- [x] 13.3 Create `_data/tools/copilot_cli.yml` for GitHub Copilot CLI
- [ ] 13.4 Update all comparison tables to include new tools
- [ ] 13.5 Generate command equivalencies for new tools
- [x] 13.6 Create profile pages for additional tools
...
- [x] 15.2 Create issue templates for tool updates and corrections
